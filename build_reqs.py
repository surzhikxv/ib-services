...
head("Telegram-бот и канал")
b("Токен собственного Telegram-бота.")
b("Права администратора в Telegram-канале.")
b("Актуальные тарифы, платёжные ссылки и правила выдачи доступа.")
...
b("Подтвердить структуру шагов и тексты собственной Telegram-воронки.")
...
b("События собственного Telegram-бота: подписчики, шаги воронки и оплаты Prodamus.")
b("Единая база и нормализация данных.")

head("Воронка")
b("Маппинг событий и шагов Telegram-бота в этапы воронки.")
