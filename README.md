...
## Статус (Phase 1, пункты 1–3 — готово)
...
Дальше: п.4 ИИ-разборы, остальные коннекторы (YouTube/VK/TG/TikTok/IG), продакшн-деплой.
...
tests/                       pytest (маппинг, клиент, синк, вебхуки, дашборд) — 71 тест
